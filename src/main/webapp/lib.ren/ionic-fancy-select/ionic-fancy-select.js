...
.directive("fancySelect", function($ionicModal) {
  return {
    ...
    scope: {
      ...
      multiSelect: "=", // Needs to have a value
    ...
    link: function(scope, element, attrs) {
      ...
      scope.$watch(function(){return scope.multiSelect;},function(newMultiSelect, oldMultiSelect){scope.multiSelect = newMultiSelect;}, true);
    }
  };
})
